...
First part of this notebook based on Karthik Ram's [GGPLOT2 Lecture][karthic] ([CC-By 2.0](https://creativecommons.org/licenses/by/2.0/))
...
![Viz](http://moderndive.com/images/coggleviz.png)
...
This famous (Fisher's or Anderson's) [iris data][iris-data] set gives the measurements in centimeters of the variables sepal length and width and petal length and width, respectively, for 50 flowers from each of 3 species of iris. The species are Iris setosa, versicolor, and virginica.
...
* In the climate data set, `Anomaly10y` is a 10-year running average of the deviation (in Celsius) from the average 1950–1980 temperature:
...
* In the climate data set, `Anomaly10y` is a 10-year running average of the deviation (in Celsius) from the average 1950–1980 temperature, and `Unc10y` is the 95% confidence interval. 
...
[karthic]: https://github.com/karthik/ggplot-lecture
